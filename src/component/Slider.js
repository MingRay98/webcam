...
class Slider extends Component {
  ...
  render() {
    return (
      <div>
        <input type="range" min="1" max="2.5" step="0.1" defaultValue="1" id="slider" className="slider"
          onChange={this.props.moveSlide} style={{ width: this.props.width , height: '1rem' }} /><br />
